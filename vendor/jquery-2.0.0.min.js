...
(function(e, undefined) {
    ...
    function(e, undefined) {
        ...
        o = ut.isXML = function(e) {
            ...
            return t !== c && 9 === t.nodeType && t.documentElement ? (c = t, f = t.documentElement, p = !o(t), b.getElementsByTagName = at(function(e) {
                ...
                return f.appendChild(e)
                    .id = y, !t.getElementsByName || !t.getElementsByName(y)
                    .length
                ...
                if (typeof t.getElementById !== j && p) {
                    var n = t.getElementById(e);
                    return n ? n.id === e || typeof n.getAttributeNode !== j && n.getAttributeNode("id")
                        .value === e ? [n] : undefined : []
                }
            }, r.filter.ID = function(e) {
                var t = e.replace(tt, nt);
        ...
        i = ut.getText = function(e) {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(tt, nt), e[3] = (e[4] || e[5] || "")
                        .replace(tt, nt), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4)
                },
                CHILD: function(e) {
            ...
            pseudos: {
                ...
                lang: st(function(e) {
                    return V.test(e || "") || ut.error("unsupported lang: " + e), e = e.replace(tt, nt)
                        .toLowerCase(),
                    function(t) {
                        var n;
        ...
        function gt(e, t) {
            ...
            return t ? a.length : a ? ut.error(e) : k(e, u)
                .slice(0)
        }
        function mt(e) {
            var t = 0,
        ...
        function wt(e) {
            ...
            for (; o > l; l++) if (n = r.relative[e[l].type]) p = [yt(vt(p), n)];
                ...
                if (n = r.filter[e[l].type].apply(null, e[l].matches), n[y]) {
                    ...
                    return bt(l > 1 && vt(p), l > 1 && mt(e.slice(0, l - 1))
                        .replace(I, "$1"), n, i > l && wt(e.slice(l, i)), o > i && wt(e = e.slice(i)), o > i && mt(e))
                }
                p.push(n)
            }
            return vt(p)
        ...
        function kt(e, t, n, i) {
            ...
            if (!i && 1 === f.length) {
                if (a = f[0] = f[0].slice(0), a.length > 2 && "ID" === (u = a[0])
                    .type && 9 === t.nodeType && p && r.relative[a[1].type]) {
        ...
        function Nt() {}
        Nt.prototype = r.filters = r.pseudos, r.setFilters = new Nt, b.sortStable = y.split("")
            .sort(S)
            .join("") === y, l(), [0, 0].sort(S), b.detectDuplicates = E, at(function(e) {
        ...
        add: function(e, t, n, i, o) {
            ...
            if (y) {
                ...
                while (c--) u = X.exec(t[c]) || [], d = m = u[1], g = (u[2] || "")
                    .split(".")
                    .sort(), d && (p = x.event.special[d] || {}, d = (o ? p.delegateType : p.bindType) || d, p = x.event.special[d] || {}, f = x.extend({
                    type: d,
                    origType: m,
                    data: i,
                    handler: n,
    ...
    x.fn.extend({
        find: function(e) {
            ...
            if ("string" != typeof e) return t = this, this.pushStack(x(e)
                .filter(function() {
        ...
        is: function(e) {
            return !!e && ("string" == typeof e ? J.test(e) ? x(e, this.context)
                .index(this[0]) >= 0 : x.filter(e, this)
    ...
    function Pt(e) {
        ...
        return n || (n = Rt(e, t), "none" !== n && n || (vt = (vt || x("<iframe frameborder='0' width='0' height='0'/>")
            ...
            .appendTo(t.documentElement), t = (vt[0].contentWindow || vt[0].contentDocument)
    ...
    x.each(["height", "width"], function(e, t) {
        ...
        x.support.reliableMarginRight || (x.cssHooks.marginRight = {
            ...
            x.cssHooks[t] = {
                get: function(e, n) {
                    return n ? (n = yt(e, t), Tt.test(n) ? x(e)
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                return this.name && !x(this)
                    .is(":disabled") && It.test(this.nodeName) && !Bt.test(e) && (this.checked || !it.test(e))
            })
                .map(function(e, t) {
                var n = x(this)
                    .val();
    ...
    x.fn.load = function(e, t, n) {
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(T)
                .complete = d.add, T.success = T.done, T.error = T.fail, c.url = ((e || c.url || Xt) + "")
                .replace(Vt, "")
                .replace(Zt, _t[1] + "//"), c.type = t.method || t.type || c.method || c.type, c.dataTypes = x.trim(c.dataType || "*")
                .toLowerCase()
                .match(w) || [""], null == c.crossDomain && (a = en.exec(c.url.toLowerCase()), c.crossDomain = !(!a || a[1] === _t[1] && a[2] === _t[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) === (_t[3] || ("http:" === _t[1] ? "80" : "443")))), c.data && c.processData && "string" != typeof c.data && (c.data = x.param(c.data, c.traditional)), un(nn, c, t, T), 2 === v) return T;
    ...
    x.each({
        ...
        setOffset: function(e, t, n) {
            var r, i, o, s, a, u, l, c = x.css(e, "position"),
                f = x(e),
                p = {};
            "static" === c && (e.style.position = "relative"), a = f.offset(), o = x.css(e, "top"), u = x.css(e, "left"), l = ("absolute" === c || "fixed" === c) && (o + u)
                .indexOf("auto") > -1, l ? (r = f.position(), s = r.top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(u) || 0), x.isFunction(t) && (t = t.call(e, n, a)), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + i), "using" in t ? t.using.call(e, p) : f.css(p)
        }
    }, x.fn.extend({
        position: function() {
            if (this[0]) {
